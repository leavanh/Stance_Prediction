# Fit BERT-Flow model using BERT embeddings
...
bertflow.save_pretrained(path + 'Models/bert-flow-model')  # Save model

# -------------------------
# Compute embeddings

bertflow = TransformerGlow.from_pretrained(path + 'Models/bert-flow-model')  # Load model
...
with open(path + "Embeddings/all_bertflow", "wb") as fp:   # Save the embeddings
