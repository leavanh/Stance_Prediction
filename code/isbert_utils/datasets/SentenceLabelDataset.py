...
class SentenceLabelDataset(Dataset):
    ...
    def __init__(self, examples: List[InputExample], model: ISBERT, provide_positive: bool = True,
        ...
        ISBERT.smart_batching_collate as the collate_fn for the DataLoader
    ...
    def convert_input_examples(self, examples: List[InputExample], model: ISBERT):
        """
