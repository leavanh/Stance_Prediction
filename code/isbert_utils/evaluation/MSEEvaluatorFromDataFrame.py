...
class MSEEvaluatorFromDataFrame(SentenceEvaluator):
    ...
    """
    def __init__(self, dataframe: List[Dict[str, str]], teacher_model: ISBERT, combinations: List[Tuple[str, str]], batch_size: int = 8, name=''):
    ...
    def __call__(self, model, output_path: str = None, epoch: int = -1, steps: int  = -1):
        ...
        return -np.mean(mse_scores) #Return negative score as ISBERTs maximizes the performance
