...
class TripletLoss(nn.Module):
    ...
    Example::
        ...
        from sentence_transformers import ISBERT,  SentencesDataset, LoggingHandler, losses
    ...
    """
    def __init__(self, model: ISBERT, distance_metric=TripletDistanceMetric.EUCLIDEAN, triplet_margin: float = 5):
